                ...
                ndata.forEach(function(obj, i, arr) {
                    ...
                    try {
                      s.graph.addNode({
                        ...
                        size: arr[i].rank * 1000,
                        color: colors[Math.floor((i / arr.length) * colors.length)]
                      });
                    } catch (e) {
                      console.log(e);
